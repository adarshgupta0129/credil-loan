					...
					<ul>
						...
						<li class="has_sub">
							...
							<ul class="list-unstyled">
								<li><a href="<?php echo base_url() ?>Financer/view_all_member/6/Customers"><i class="fa fa-angle-double-right"></i> View Customers</a></li>
								<li><a href="<?php echo base_url() ?>Financer/view_loan_request"><i class="fa fa-angle-double-right"></i> Loan Requests</a></li>
							</ul>
						</li>
