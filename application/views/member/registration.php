...
<div class="row">
	<div class="col-lg-8 col-lg-offset-2 col-md-10">
		<div class="card-box">
			<h2 class="form-section"><?php echo uri(4) ?> Registration</h2>
			...
			<div class="form">
				...
				<div class="row">
					...
					<div class="form-group">
						<label class="col-md-4 control-label"><?php echo uri(4) ?> Name <span class="required"> * </span>
						</label>
						<div class="col-md-5">
				...
				<input type="hidden" name="txtusertype" id="txtusertype" value="<?=uri(3)?>" />
