						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table border table-bordered text-nowrap">
									...
									<tbody>
										<?php $price = $delivery = $discount = $pur_type_charge = $final = "0"; $sn=1;
															...
															<table class="table">
																<tr>
																	<td colspan="2" align="right"><b>Invoice</b> : <?=$data->pur_all_trans_id?> 
																		<!-- <a title="invoice" target="_blank" href="<?=base_url()?>Userprofile/view_purchase_details/<?=$data->pur_all_trans_id?>"><i class="fa fa-print"></i></a> -->
																	</td>
																</tr>
																<tr>
