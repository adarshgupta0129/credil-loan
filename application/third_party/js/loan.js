...
(function(S, K) {
    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            dSetter: function() {
                var a = this.paths[0], f = this.paths[1], e = [], u = this.now, x = a.length, t;
                if (1 === u)
                    e = this.toD;
            ...
            update: function() {
                ...
                if (this[f + "Setter"])
                    ...
                    a.attr ? a.element && a.attr(f, e, null, !0) : a.style[f] = e + this.unit;
                u && u.call(a, e, this)
            },
            run: function(n, f, e) {
                var u = this
                ...
                n !== f || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date,
                this.start = n,
                this.end = f,
                this.unit = e,
                this.now = this.start,
                ...
                t.elem = this.elem,
                t.prop = this.prop,
                t() && 1 === a.timers.push(t) && w(y)) : (delete x.curAnim[this.prop],
                x.complete && 0 === a.keys(x.curAnim).length && x.complete.call(this.elem))
            },
            step: function(n) {
                var f = +new Date, e, u = this.options, x = this.elem, t = u.complete, w = u.duration, y = u.curAnim;
                x.attr && !x.element ? n = !1 : n || f >= w + this.startTime ? (this.now = this.end,
                this.pos = 1,
                this.update(),
                e = y[this.prop] = !0,
                ...
                e && t && t.call(x),
                n = !1) : (this.pos = u.easing((f - this.startTime) / w),
            ...
            initPath: function(n, f, e) {
                function u(a) {
                    ...
                    for (d = a.length; d--; )
                        b = "M" === a[d] || "L" === a[d],
                        k = /[a-zA-Z]/.test(a[d + 3]),
                        b && k && a.splice(d + 1, 0, a[d + 1], a[d + 2], a[d + 1], a[d + 2])
                }
                function x(a, h) {
                    for (; a.length < k; ) {
                        a[0] = h[k - a.length];
                ...
                f.length && a.isNumber(w) && (k = e.length + w * v * p,
                J ? (x(f, e),
                t(e, f)) : (x(e, f),
                t(f, e)));
                return [f, e]
        ...
        a.merge = function() {
            ...
            !0 === f[0] && (u = f[1],
            f = Array.prototype.slice.call(f, 2));
            e = f.length;
            for (n = 0; n < e; n++)
                u = x(u, f[n]);
            return u
        ...
        ;
        a.pick = function() {
            var a = arguments, f, e, u = a.length;
            for (f = 0; f < u; f++)
                if (e = a[f],
                void 0 !== e && null !== e)
                    return e
        ...
        a.formatSingle = function(n, f, e) {
            ...
            /f$/.test(n) ? (e = (e = n.match(u)) ? e[1] : -1,
            null !== f && (f = a.numberFormat(f, e, x.decimalPoint, -1 < n.indexOf(",") ? x.thousandsSep : ""))) : f = (e || a.time).dateFormat(n, f);
            return f
        }
        ;
        ...
        a.normalizeTickInterval = function(n, f, e, u, x) {
            ...
            e = a.pick(e, 1);
            t = n / e;
            f || (f = x ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10],
            !1 === u && (1 === e ? f = a.grep(f, function(a) {
                return 0 === a % 1
            }) : .1 >= e && (f = [1 / e])));
            for (u = 0; u < f.length && !(w = f[u],
            x && w * e >= n || !x && t <= (f[u] + (f[u + 1] || f[u])) / 2); u++)
                ;
        ...
        a.numberFormat = function(n, f, e, u) {
            ...
            -1 === f ? f = Math.min(t, 20) : a.isNumber(f) ? f && c[1] && 0 > c[1] && (w = f + +c[1],
            0 <= w ? (c[0] = (+c[0]).toExponential(w).split("e")[0],
            f = w) : (c[0] = c[0].split(".")[0] || 0,
        ...
        a.addEvent = function(n, f, e, u) {
            ...
            x[f] || (x[f] = []);
            x[f].push(e);
            u && a.isNumber(u.order) && (e.order = u.order,
        ...
        a.fireEvent = function(n, f, e, u) {
            var x, t, w, y, c;
            e = e || {};
            F.createEvent && (n.dispatchEvent || n.fireEvent) ? (x = F.createEvent("Events"),
            x.initEvent(f, !0, !0),
            a.extend(x, e),
            n.dispatchEvent ? n.dispatchEvent(x) : n.fireEvent(f, x)) : a.each(["protoEvents", "hcEvents"], function(h) {
                if (n[h])
                    for (t = n[h][f] || [],
                    w = t.length,
                    e.target || a.extend(e, {
        ...
        a.animate = function(n, f, e) {
            ...
            a.objectEach(f, function(c, h) {
                ...
                w = new a.Fx(n,e,h);
                t = null;
                "d" === h ? (w.paths = w.initPath(n, n.d, f.d),
                w.toD = f.d,
                u = 0,
                t = 1) : n.attr ? u = n.attr(h) : (u = parseFloat(a.getStyle(n, h)) || 0,
                "opacity" !== h && (x = "px"));
                t || (t = c);
        ...
        I.jQuery && (I.jQuery.fn.highcharts = function() {
            ...
            if (this[0])
                return n[0] ? (new (a[a.isString(n[0]) ? n.shift() : "Chart"])(this[0],n[0],n[1]),
    ...
    (function(a) {
        ...
        a.Color.prototype = {
            ...
            init: function(e) {
                ...
                else if (e && e.charAt && "#" === e.charAt() && (f = e.length,
                e = parseInt(e.substr(1), 16),
                7 === f ? x = [(e & 16711680) >> 16, (e & 65280) >> 8, e & 255, 1] : 4 === f && (x = [(e & 3840) >> 4 | (e & 3840) >> 8, (e & 240) >> 4 | e & 240, (e & 15) << 4 | e & 15, 1])),
                !x)
            ...
            get: function(a) {
                var e = this.input, f = this.rgba, t;
                this.stops ? (t = n(e),
            ...
            tweenTo: function(a, f) {
                var e = this.rgba
                  , t = a.rgba;
                t.length && e && e.length ? (a = 1 !== t[3] || 1 !== e[3],
                f = (a ? "rgba(" : "rgb(") + Math.round(t[0] + (e[0] - t[0]) * (1 - f)) + "," + Math.round(t[1] + (e[1] - t[1]) * (1 - f)) + "," + Math.round(t[2] + (e[2] - t[2]) * (1 - f)) + (a ? "," + (t[3] + (e[3] - t[3]) * (1 - f)) : "") + ")") : f = a.input || "none";
                return f
            }
        };
        a.color = function(e) {
    ...
    (function(a) {
        ...
        k(C.prototype, {
            ...
            animate: function(z, g, r) {
                ...
                0 !== g.duration ? (r && (g.complete = r),
                n(this, z, g)) : (this.attr(z, null, r),
                g.step && g.step.call(this));
                return this
            },
            complexColor: function(z, g, r) {
                var b = this.renderer, k, m, d, H, c, h, q, A, v, P, l, O = [], M;
                a.fireEvent(this.renderer, "complexColor", {
                    ...
                    "radialGradient" === m && P && !w(d.gradientUnits) && (H = d,
                    ...
                    O = O.join(","),
                    c[O] ? l = c[O].attr("id") : (d.id = l = a.uniqueKey(),
            ...
            applyTextOutline: function(z) {
                ...
                if ((d = z[0]) && "none" !== d && a.svg) {
                    ...
                    for (k = z.length; k--; )
                        r = z[k],
                        "highcharts-text-outline" === r.getAttribute("class") && q(z, g.removeChild(r));
                    m = g.firstChild;
                    p(z, function(a, z) {
            ...
            attr: function(a, g, r, b) {
                var z, d = this.element, m, k = this, c, H;
                "string" === typeof a && void 0 !== g && (z = a,
                a = {},
                a[z] = g);
                "string" === typeof a ? k = (this[a + "Getter"] || this._defaultGetter).call(this, a, d) : (N(a, function(z, g) {
                    c = !1;
                    b || M(this, g);
                    this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(g) && (m || (this.symbolAttr(a),
                    m = !0),
                    c = !0);
                    !this.rotation || "x" !== g && "y" !== g || (this.doTransform = !0);
                    c || (H = this[g + "Setter"] || this._defaultSetter,
                    H.call(this, z, g, d),
                    this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(g) && this.updateShadows(g, z, H))
                }, this),
                this.afterSetters());
                r && r.call(this);
                return k
            ...
            css: function(a) {
                var z = this.styles, r = {}, d = this.element, b, m = "", c, H = !z, h = ["textOutline", "textOverflow", "width"];
                ...
                H && (z && (a = k(z, r)),
                a && (null === a.width || "auto" === a.width ? delete this.textWidth : "text" === d.nodeName.toLowerCase() && a.width && (b = this.textWidth = g(a.width))),
                this.styles = a,
                b && !O && this.renderer.forExport && delete a.width,
                d.namespaceURI === this.SVG_NS ? (c = function(a, z) {
            ...
            getBBox: function(a, g) {
                var z, r = this.renderer, d, b = this.element, m = this.styles, c, H = this.textStr, h, q = r.cache, A = r.cacheKeys, v = b.namespaceURI === this.SVG_NS, l;
                g = E(g, this.rotation);
                d = g * y;
                c = m && m.fontSize;
                w(H) && (l = H.toString(),
                ...
                if (!z) {
                    ...
                    v && (z.height = r = {
                        "11px,17": 14,
                        "13px,20": 16
                    }[m && m.fontSize + "," + Math.round(r)] || r),
                    g && (z.width = Math.abs(r * Math.sin(d)) + Math.abs(a * Math.cos(d)),
                    z.height = Math.abs(r * Math.cos(d)) + Math.abs(a * Math.sin(d))));
                    if (l && 0 < z.height) {
                        for (; 250 < A.length; )
                            delete q[A.shift()];
                        q[l] || A.push(l);
            ...
            add: function(a) {
                var g = this.renderer, z = this.element, r;
            ...
            shadow: function(a, g, r) {
                var z = [], d, b, m = this.element, k, c, H, h;
                if (!a)
                    this.destroyShadows();
                    ...
                    for (d = 1; d <= c; d++)
                        ...
                        r && (f(b, "height", Math.max(f(b, "height") - k, 0)),
                        b.cutHeight = k),
                        g ? g.element.appendChild(b) : m.parentNode && m.parentNode.insertBefore(b, m),
                        z.push(b);
                    this.shadows = z
                }
                return this
            ...
            titleSetter: function(a) {
                ...
                g || (g = h.createElementNS(this.SVG_NS, "title"),
            ...
            zIndexSetter: function(a, r) {
                var z = this.renderer, d = this.parentGroup, b = (d || z).element || z.box, m, k = this.element, c, H, z = b === z.box;
                m = this.added;
                var h;
                w(a) ? (k.setAttribute("data-z-index", a),
                a = +a,
                this[r] === a && (m = !1)) : w(this[r]) && k.removeAttribute("data-z-index");
                this[r] = a;
                if (m) {
                    ...
                    for (h = r.length - 1; 0 <= h && !c; h--)
                        ...
                        d !== k)
                            if (0 > a && H && !z && !h)
                                b.insertBefore(k, r[h]),
                                c = !0;
                            else if (g(m) <= a || H && (!w(a) || 0 <= a))
                                b.insertBefore(k, r[h + 1] || null),
                                c = !0;
                    c || (b.insertBefore(k, r[z ? 3 : 0] || null),
                    c = !0)
                }
                return c
            },
        ...
        C.prototype["stroke-widthSetter"] = C.prototype.strokeSetter = function(a, g, r) {
            this[g] = a;
            this.stroke && this["stroke-width"] ? (C.prototype.fillSetter.call(this, this.stroke, "stroke", r),
            r.setAttribute("stroke-width", this["stroke-width"]),
            this.hasStroke = !0) : "stroke-width" === g && 0 === a && this.hasStroke && (r.removeAttribute("stroke"),
            this.hasStroke = !1)
        }
        ;
        ...
        k(F.prototype, {
            ...
            buildText: function(a) {
                var r = a.element, b = this, m = b.forExport, c = E(a.textStr, "").toString(), z = -1 !== c.indexOf("\x3c"), k = r.childNodes, q, A = f(r, "x"), l = a.styles, G = a.textWidth, M = l && l.lineHeight, e = l && l.textOutline, B = l && "ellipsis" === l.textOverflow, R = l && "nowrap" === l.whiteSpace, y = l && l.fontSize, t, D, J = k.length, l = G && !a.added && this.box, w = function(a) {
                    ...
                    r = a.indexOf(g + "\x3d");
                    if (-1 !== r && (r = r + g.length + 1,
                    g = a.charAt(r),
                    '"' === g || "'" === g))
                        return a = a.substring(r + 1),
                ...
                if (t !== a.textCache) {
                    for (a.textCache = t; J--; )
                        r.removeChild(k[J]);
                    z || e || B || G || -1 !== c.indexOf(" ") ? (l && l.appendChild(r),
                    c = z ? c.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [c],
                    c = d(c, function(a) {
                        return "" !== a
                    }),
                    p(c, function(g, d) {
                        ...
                        p(c, function(g) {
                            if ("" !== g || 1 === c.length) {
                                var v = {}, l = h.createElementNS(b.SVG_NS, "tspan"), p, M;
                                (p = u(g, "class")) && f(l, "class", p);
                                if (p = u(g, "style"))
                                    p = p.replace(/(;| |^)color([ :])/, "$1fill$2"),
                                    f(l, "style", p);
                                (M = u(g, "href")) && !m && (f(l, "onclick", 'location.href\x3d"' + M + '"'),
                                ...
                                if (" " !== g) {
                                    ...
                                    if (G) {
                                        ...
                                        var t = w(l);
                                        if (B)
                                            q = b.truncate(a, l, g, void 0, 0, Math.max(0, G - parseInt(y || 12, 10)), function(a, g) {
                                                return a.substring(0, g) + "\u2026"
                                            });
                                        else if (v)
                                            for (; e.length; )
                                                e.length && !R && 0 < M && (l = h.createElementNS(H, "tspan"),
                                                f(l, {
                                                    dy: t,
                                                    x: A
                                                }),
                                                p && f(l, "style", p),
                                                l.appendChild(h.createTextNode(e.join(" ").replace(/- /g, "-"))),
                                                r.appendChild(l)),
                                                b.truncate(a, l, null, e, 0 === M ? k : 0, G, function(a, g) {
                    ...
                    l && l.removeChild(r),
                    e && a.applyTextOutline && a.applyTextOutline(e)) : r.appendChild(h.createTextNode(Q(c)))
                }
            },
            ...
            image: function(a, g, r, d, b, c) {
                ...
                c ? (h(H.element, "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d"),
                m = new Q.Image,
                I(m, "load", q),
                m.src = a,
                m.complete && q({})) : h(H.element, a);
                return H
            },
            symbol: function(a, g, r, d, b, c) {
                var m = this, H, q = /^url\((.*?)\)$/, A = q.test(a), v = !A && (this.symbols[a] ? a : "circle"), z = v && this.symbols[v], l = w(g) && z && z.call(this.symbols, Math.round(g), Math.round(r), d, b, c), G, M;
                z ? (H = this.path(l),
                H.attr("fill", "none"),
                k(H, {
                    symbolName: v,
                ...
                p(["width", "height"], function(a) {
                    H[a + "Setter"] = function(a, g) {
                        ...
                        this.alignByTranslate || (r[b] = ((this[g] || 0) - d) / 2,
                        this.attr(r)))
                    }
                }),
                w(g) && H.attr({
                ...
                H.isImg = !0,
                w(H.imgwidth) && w(H.imgheight) ? M() : (H.attr({
                    width: 0,
                    height: 0
                }),
                t("img", {
            ...
            text: function(a, g, r, d) {
                ...
                d || (a.xSetter = function(a, g, r) {
                    var d = r.getElementsByTagName("tspan"), b, c = r.getAttribute(g), m;
            ...
            label: function(g, d, b, c, m, H, h, q, A) {
                var v = this, l = v.g("button" !== A && "label"), M = l.text = v.text("", 0, 0, h).attr({
                    zIndex: 1
                }), O, z, e = 0, B = 3, R = 0, f, y, t, D, J, E = {}, N, x, Q = /^url\((.*?)\)$/.test(c), u = Q, L, n, P, T;
                ...
                n = function() {
                    ...
                    u && (O || (l.box = O = v.symbols[c] || Q ? v.symbol(c) : v.rect(),
                    O.addClass(("button" === A ? "" : "highcharts-label-box") + (A ? " highcharts-" + A + "-box" : "")),
                    O.add(l),
                    a = L(),
                    g.x = a,
                    g.y = (q ? -x : 0) + a),
                ...
                P = function() {
                    ...
                    if (a !== M.x || g !== M.y)
                        M.attr("x", a),
                        M.hasBoxWidthChanged && (z = M.getBBox(!0),
                        n()),
                        void 0 !== g && M.attr("y", g);
                    M.x = a;
                    M.y = g
        ...
        e(a.SVGElement.prototype, {
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    if ("SPAN" === c.tagName) {
                        var B = this.rotation, m = this.textWidth && y(this.textWidth), G = [B, l, c.innerHTML, this.textWidth, this.textAlign].join(), A;
                        ...
                        G !== this.cTT && (t = a.fontMetrics(c.style.fontSize).b,
                        !n(B) || B === (this.oldRotation || 0) && l === this.oldAlign || this.setSpanRotation(B, e, t),
                        this.getSpanCorrection(!n(B) && this.textPxLength || c.offsetWidth, t, e, B, l));
                        I(c, {
    ...
    (function(a) {
        ...
        a.Time.prototype = {
            ...
            makeTime: function(e, t, w, y, c, h) {
                var p, k, q;
                this.useUTC ? (p = this.Date.UTC.apply(0, arguments),
                k = this.getTimezoneOffset(p),
                p += k,
                q = this.getTimezoneOffset(p),
                k !== q ? p += q - k : k - 36E5 !== this.getTimezoneOffset(p - 36E5) || a.isSafari || (p -= 36E5)) : p = (new this.Date(e,t,f(w, 1),f(y, 0),f(c, 0),f(h, 0))).getTime();
                return p
            },
            ...
            getTimeTicks: function(a, t, w, y) {
                var c = this, h = [], p, k = {}, q;
                p = new c.Date(t);
                var d = a.unitRange, b = a.count || 1, v;
                y = f(y, 1);
                if (C(t)) {
                    ...
                    d >= e.month && (c.set("Month", p, d >= e.year ? 0 : b * Math.floor(c.get("Month", p) / b)),
                    q = c.get("FullYear", p));
                    d >= e.year && c.set("FullYear", p, q - q % b);
                    d === e.week && (q = c.get("Day", p),
                    ...
                    for (p = 1; t < w; )
                        h.push(t),
                        t = d === e.year ? c.makeTime(q + p * b, 0) : d === e.month ? c.makeTime(q, y + p * b) : !v || d !== e.day && d !== e.week ? v && d === e.hour && 1 < b ? c.makeTime(q, y, J, l + p * b) : t + d * b : c.makeTime(q, y, J + p * b * (d === e.day ? 1 : 7)),
                        p++;
                    h.push(t);
    ...
    (function(a) {
        ...
        a.Tick.prototype = {
            addLabel: function() {
                var f = this, w = f.axis, y = w.options, c = w.chart, h = w.categories, p = w.names, k = f.pos, q = u(f.options && f.options.labels, y.labels), d = w.tickPositions, b = k === d[0], v = k === d[d.length - 1], h = this.parameters.category || (h ? u(h[k], p[k], k) : k), J = f.label, d = d.info, l, n, B, D;
                w.isDatetimeAxis && d && (n = c.time.resolveDTLFormat(y.dateTimeLabelFormats[!y.grid && d.higherRanks[k] || d.unitName]),
                l = n.main);
                f.isFirst = b;
                f.isLast = v;
                f.formatCtx = {
                ...
                if (D = n && n.list)
                    ...
                    ;
                if (F(J))
                    J && J.textStr !== y && (!J.textWidth || q.style && q.style.width || J.styles.width || J.css({
                        width: null
                    }),
                    J.attr({
                        text: y
                    ...
                    if (f.label = J = F(y) && q.enabled ? c.renderer.text(y, 0, 0, q.useHTML).css(e(q.style)).add(w.labelGroup) : null)
            ...
            handleOverflow: function(a) {
                var e = this.axis, f = e.options.labels, c = a.x, h = e.chart.chartWidth, p = e.chart.spacing, k = u(e.labelLeft, Math.min(e.pos, p[3])), p = u(e.labelRight, Math.max(e.isRadial ? 0 : e.pos + e.len, h - p[1])), q = this.label, d = this.rotation, b = {
                    left: 0,
                    center: .5,
                    right: 1
                }[e.labelAlign || q.attr("align")], v = q.getBBox().width, J = e.getSlotWidth(this), l = J, t = 1, B, D = {};
                if (d || "justify" !== u(f.overflow, "justify"))
                    0 > d && c - b * v < k ? B = Math.round(c / Math.cos(d * x) - k) : 0 < d && c + b * v > p && (B = Math.round((h - c) / Math.cos(d * x)));
                else if (h = c + (1 - b) * v,
                c - b * v < k ? l = a.x + l * (1 - b) - k : h > p && (l = p - a.x + l * b,
                t = -1),
                l = Math.min(J, l),
                l < J && "center" === e.labelAlign && (a.x += t * (J - l - b * (J - Math.min(v, l)))),
                v > l || e.autoRotation && (q.styles || {}).width)
                    B = l;
                B && (this.shortenLabel ? this.shortenLabel() : (D.width = B,
            ...
            renderGridLine: function(a, e, f) {
                ...
                d || (k.zIndex = 1),
                a && (e = 0),
                this.gridLine = p = v.path().attr(k).addClass("highcharts-" + (d ? d + "-" : "") + "grid-line").add(c.gridGroup));
            ...
            renderMark: function(a, e, f) {
                ...
                var l = u(h[q + "Width"], !k && c.isXAxis ? 1 : 0)
                  , h = h[q + "Color"];
                d && (c.opposite && (d[0] = -d[0]),
                v && (this.mark = b = p.path().addClass("highcharts-" + (k ? k + "-" : "") + "tick").add(c.axisGroup),
                b.attr({
                    stroke: h,
                    "stroke-width": l
                })),
            ...
            renderLabel: function(a, e, y, c) {
                var h = this.axis
                  ...
                  , J = a.x;
                a = a.y;
                q && f(J) && (q.xy = a = this.getLabelPosition(J, a, q, p, d, h, c, b),
                this.isFirst && !this.isLast && !u(k.showFirstLabel, 1) || this.isLast && !this.isFirst && !u(k.showLastLabel, 1) ? v = !1 : !p || d.step || d.rotation || e || 0 === y || this.handleOverflow(a),
                b && c % b && (v = !1),
                v && f(a.y) ? (a.opacity = y,
                q[this.isNewLabel ? "attr" : "animate"](a),
                this.isNewLabel = !1) : (q.attr("y", -9999),
                this.isNewLabel = !0))
            },
    ...
    var W = function(a) {
        ...
        a.extend(E.prototype, {
            ...
            init: function(a, r) {
                ...
                r = b.options.events;
                -1 === d(b, a.axes) && (g ? a.axes.splice(a.xAxis.length, 0, b) : a.axes.push(b),
                a[b.coll].push(b));
                b.series = b.series || [];
            ...
            defaultLabelFormatter: function() {
                var g = this.axis, r = this.value, b = g.chart.time, d = g.categories, c = this.dateTimeLabelFormat, m = u.lang, k = m.numericSymbols, m = m.numericSymbolMagnitude || 1E3, h = k && k.length, l, q = g.options.labels.format, g = g.isLog ? Math.abs(r) : g.tickInterval;
                if (q)
                    l = p(q, this, b);
                else if (d)
                    l = r;
                    ...
                    for (; h-- && void 0 === l; )
                        b = Math.pow(m, h + 1),
                        g >= b && 0 === 10 * r % b && null !== k[h] && 0 !== r && (l = a.numberFormat(r / b, -1) + k[h]);
                ...
                h(this, "getSeriesExtremes", null, function() {
                    ...
                    y(a.series, function(g) {
                        if (g.visible || !r.options.chart.ignoreHiddenSeries) {
                            var b = g.options, d = b.threshold, c;
                            ...
                            if (a.isXAxis)
                                ...
                                b.length && (g = n(b),
                                c = I(b),
                                v(g) || g instanceof Date || (b = q(b, v),
                                g = n(b),
                                c = I(b)),
                                b.length && (a.dataMin = Math.min(D(a.dataMin, b[0], g), g),
                                a.dataMax = Math.max(D(a.dataMax, b[0], c), c)));
                            else if (g.getExtremes(),
                            c = g.dataMax,
                            g = g.dataMin,
                            x(g) && x(c) && (a.dataMin = Math.min(D(a.dataMin, g), g),
            ...
            translate: function(a, r, b, d, c, m) {
                ...
                H -= k * (g.sector || g.len));
                r ? (a = (a * k + H - h) / l + d,
                c && (a = g.lin2val(a))) : (c && (a = g.val2lin(a)),
                a = v(d) ? k * (a - d) * l + H + k * h + (v(m) ? l * m : 0) : void 0);
                return a
            },
            ...
            getPlotLinePath: function(a, r, b, d, c) {
                var g = this.chart, m = this.left, k = this.top, H, l, h = b && g.oldChartHeight || g.chartHeight, q = b && g.oldChartWidth || g.chartWidth, A;
                H = this.transB;
                ...
                v(c) ? this.horiz ? (H = k,
                l = h - this.bottom,
                a = b = e(a, m, m + this.width)) : (a = m,
                b = q - this.right,
                H = l = e(H, k, k + this.height)) : (A = !0,
                d = !1);
            ...
            getMinorTickPositions: function() {
                ...
                if (l && l / d < a.len / 3)
                    if (a.isLog)
                        ...
                        c = c.concat(a.getTimeTicks(a.normalizeTimeTickInterval(d), k, m, r.startOfWeek));
                    else
            ...
            adjustForMinRange: function() {
                var a = this.options, r = this.min, b = this.max, d, c, m, k, l, h, q, v;
                ...
                b - r < this.minRange && (c = this.dataMax - this.dataMin >= this.minRange,
                v = this.minRange,
                d = (v - b + r) / 2,
                d = [r - d, D(a.min, r - d)],
            ...
            nameToX: function(a) {
                var g = b(this.categories), c = g ? this.categories : this.names, m = a.options.x, k;
            ...
            updateNames: function() {
                ...
                y(this.series || [], function(a) {
                    ...
                    y(a.points, function(r, b) {
                        var d;
                        r.options && (d = g.nameToX(r),
                        void 0 !== d && d !== r.x && (r.x = d,
                        a.xData[b] = d))
                    })
                }))
            },
            setAxisTranslation: function(a) {
                var g = this, b = g.max - g.min, d = g.axisPointRange || 0, c, m = 0, k = 0, l = g.linkedParent, q = !!g.categories, v = g.transA, A = g.isXAxis;
                if (A || q || d)
                    c = g.getClosest(),
                    l ? (m = l.minPointOffset,
                    k = l.pointRangePadding) : y(g.series, function(a) {
                        var b = q ? 1 : A ? D(a.options.pointRange, c, 0) : g.axisPointRange || 0;
                        a = a.options.pointPlacement;
                        d = Math.max(d, b);
                        g.single || (m = Math.max(m, J(a) ? 0 : b / 2),
            ...
            setTickInterval: function(g) {
                var b = this, d = b.chart, c = b.options, m = b.isLog, l = b.isDatetimeAxis, q = b.isXAxis, A = b.isLinked, p = c.maxPadding, f = c.minPadding, G = c.tickInterval, B = c.tickPixelInterval, J = b.categories, E = v(b.threshold) ? b.threshold : null, N = b.softThreshold, w, t, u, n;
                l || J || A || this.getTickAmount();
                u = D(b.userMin, c.min);
                n = D(b.userMax, c.max);
                A ? (b.linkedParent = d[b.coll][c.linkedTo],
                d = b.linkedParent.getExtremes(),
                b.min = D(d.min, d.dataMin),
                b.max = D(d.max, d.dataMax),
                c.type !== b.linkedParent.options.type && a.error(11, 1)) : (!N && x(E) && (b.dataMin >= E ? (w = E,
                f = 0) : b.dataMax <= E && (t = E,
                p = 0)),
                b.min = D(u, w, b.dataMin),
                b.max = D(n, t, b.dataMax));
                m && (b.positiveValuesOnly && !g && 0 >= Math.min(b.min, D(b.dataMin, b.min)) && a.error(10, 1),
                b.min = e(b.log2lin(b.min), 15),
                b.max = e(b.log2lin(b.max), 15));
                b.range && x(b.max) && (b.userMin = b.min = u = Math.max(b.dataMin, b.minFromRange()),
                b.userMax = n = b.max,
                b.range = null);
                h(b, "foundExtremes");
                b.beforePadding && b.beforePadding();
                b.adjustForMinRange();
                !(J || b.axisPointRange || b.usePercentage || A) && x(b.min) && x(b.max) && (d = b.max - b.min) && (!x(u) && f && (b.min -= d * f),
                !x(n) && p && (b.max += d * p));
                ...
                N && x(b.dataMin) && (E = E || 0,
                !x(u) && b.min < E && b.dataMin >= E ? b.min = E : !x(n) && b.max > E && b.dataMax <= E && (b.max = E));
            ...
            zoom: function(a, b) {
                ...
                if (a !== this.min || b !== this.max)
                    this.allowZoomOutside || (x(g) && (a < m && (a = m),
                    a > c && (a = c)),
                    x(d) && (b < m && (b = m),
                    b > c && (b = c))),
            ...
            unsquish: function() {
                var a = this.options.labels, b = this.horiz, d = this.tickInterval, c = d, m = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d), k, l = a.rotation, h = this.labelMetrics(), q, v = Number.MAX_VALUE, A, p = function(a) {
                    a /= m || 1;
                    a = 1 < a ? Math.ceil(a) : 1;
                    return e(a * d)
                };
            ...
            renderUnsquish: function() {
                var a = this.chart, b = a.renderer, d = this.tickPositions, c = this.ticks, m = this.options.labels, k = m && m.style || {}, l = this.horiz, h = this.getSlotWidth(), q = Math.max(1, Math.round(h - 2 * (m.padding || 5))), v = {}, A = this.labelMetrics(), e = m.style && m.style.textOverflow, p, f, G = 0, B;
                ...
                if (this.autoRotation)
                    G > q && G > A.h ? v.rotation = this.labelRotation : this.labelRotation = 0;
                else if (h && (p = q,
                !e))
                    for (f = "clip",
                    q = d.length; !l && q--; )
                ...
                y(d, function(a) {
                    var b = (a = c[a]) && a.label
                      ...
                      , d = {};
                    b && (b.attr(v),
                    a.shortenLabel ? a.shortenLabel() : p && !g && "nowrap" !== k.whiteSpace && (p < b.textPxLength || "SPAN" === b.element.tagName) ? (d.width = p,
            ...
            addTitle: function(a) {
                ...
                this.axisTitle = b.text(c.text, 0, 0, c.useHTML).attr({
                    ...
                    align: m
                }).addClass("highcharts-axis-title").css(l(c.style)).add(this.axisGroup),
            ...
            getOffset: function() {
                var a = this, b = a.chart, d = b.renderer, c = a.options, m = a.tickPositions, k = a.ticks, l = a.horiz, q = a.side, v = b.inverted && !a.isZAxis ? [1, 0, 3, 2][q] : q, A, e, p = 0, G, f = 0, J = c.title, E = c.labels, N = 0, w = b.axisOffset, b = b.clipOffset, t = [-1, 1, 1, -1][q], u = c.className, n = a.axisParent;
                A = a.hasData();
                ...
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (u || "")).add(n),
                a.axisGroup = d.g("axis").attr({
                    zIndex: c.zIndex || 2
                }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (u || "")).add(n),
                ...
                a.renderUnsquish(),
                a.reserveSpaceDefault = 0 === q || 2 === q || {
                    1: "left",
                    3: "right"
                }[q] === a.labelAlign,
                D(E.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && y(m, function(a) {
                    N = Math.max(k[a].getLabelSize(), N)
                }),
                a.staggerLines && (N *= a.staggerLines),
                a.labelOffset = N * (a.opposite ? -1 : 1)) : B(k, function(a, b) {
                    a.destroy();
                    delete k[b]
                });
                J && J.text && !1 !== J.enabled && (a.addTitle(e),
                e && !1 !== J.reserveSpace && (a.titleOffset = p = a.axisTitle.getBBox()[l ? "height" : "width"],
                G = J.offset,
            ...
            render: function() {
                var b = this, d = b.chart, c = b.options, m = b.isLog, k = b.isLinked, l = b.tickPositions, q = b.axisTitle, e = b.ticks, p = b.minorTicks, f = b.alternateBands, G = c.stackLabels, J = c.alternateGridColor, E = b.tickmarkOffset, D = b.axisLine, t = b.showAxis, w = F(d.renderer.globalAnimation), u, n;
                ...
                if (b.hasData() || k)
                    b.minorTickInterval && !b.categories && y(b.getMinorTickPositions(), function(a) {
                        b.renderMinorTick(a)
                    }),
                    l.length && (y(l, function(a, d) {
                        b.renderTick(a, d)
                    }),
                    E && (0 === b.min || b.single) && (e[-1] || (e[-1] = new N(b,-1,null,!0)),
                    e[-1].render(-1))),
                    J && y(l, function(c, g) {
                        n = void 0 !== l[g + 1] ? l[g + 1] + E : b.max - E;
                        0 === g % 2 && c < b.max && n <= b.max + (d.polar ? -E : E) && (f[c] || (f[c] = new a.PlotLineOrBand(b)),
                        u = c + E,
                        f[c].options = {
                ...
                D.isPlaced = !0,
                D[t ? "show" : "hide"](!0));
                q && t && (c = b.getTitlePosition(),
                v(c.y) ? (q[q.isNew ? "attr" : "animate"](c),
                q.isNew = !1) : (q.attr("y", -9999),
                q.isNew = !0));
            ...
            drawCrosshair: function(a, b) {
                var d, c = this.crosshair, g = D(c.snap, !0), m, k = this.cross;
    ...
    (function(a) {
        ...
        C.prototype.normalizeTimeTickInterval = function(a, e) {
            ...
            e = f[f.length - 1];
            var x = n[e[0]], t = e[1], w;
            for (w = 0; w < f.length && !(e = f[w],
            x = n[e[0]],
            t = e[1],
            f[w + 1] && a <= (x * t[t.length - 1] + n[f[w + 1][0]]) / 2); w++)
                ;
    ...
    (function(a) {
        ...
        C.prototype.getLogTickPositions = function(a, u, x, t) {
            ...
            if (.5 <= a)
                a = Math.round(a),
                c = this.getLinearTickPositions(a, u, x);
            else if (.08 <= a)
                for (var y = Math.floor(u), h, p, k, q, d, e = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; y < x + 1 && !d; y++)
                    for (p = e.length,
                    h = 0; h < p && !d; h++)
                ...
                a = f("auto" === a ? null : a, this._minorAutoInterval, e.tickPixelInterval / (t ? 5 : 1) * (x - u) / ((t ? y / this.tickPositions.length : y) || 1)),
                a = n(a, null, F(a)),
    ...
    (function(a, C) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                var e = this
                  ...
                  , N = f.chart.renderer
                  , E = v ? "bands" : "lines";
                f.isLog && (d = f.log2lin(d),
                q = f.log2lin(q),
                b = f.log2lin(b));
                J ? (B.stroke = D,
                B["stroke-width"] = h.width,
                h.dashStyle && (B.dashstyle = h.dashStyle)) : v && (D && (B.fill = D),
                h.borderWidth && (B.stroke = h.borderColor,
                ...
                if (J)
                    B = f.getPlotLinePath(b, l.strokeWidth());
                else if (v)
                    B = f.getPlotBandPath(d, q, h);
                else
                    return;
                u && B && B.length ? (l.attr({
                    d: B
        ...
        a.extend(C.prototype, {
            getPlotBandPath: function(a, e) {
                var c = this.getPlotLinePath(e, null, null, !0), h = this.getPlotLinePath(a, null, null, !0), p = [], k = this.horiz, q = 1, d;
                a = a < this.min && e < this.min || a > this.max && e > this.max;
                if (h && c)
                    for (a && (d = h.toString() === c.toString(),
                    q = 0),
                    a = 0; a < h.length; a += 6)
                        k && c[a + 1] === h[a + 1] ? (c[a + 1] += q,
                        c[a + 4] += q) : k || c[a + 2] !== h[a + 2] || (c[a + 2] += q,
                        c[a + 5] += q),
                        p.push("M", h[a + 1], h[a + 2], "L", h[a + 4], h[a + 5], c[a + 4], c[a + 5], c[a + 1], c[a + 2], "z"),
                        p.isFlat = d;
                return p
            },
    ...
    (function(a) {
        ...
        a.Tooltip.prototype = {
            ...
            getLabel: function() {
                var c = this.chart.renderer, h = this.options, e;
                ...
                this.split ? this.label = c.g("tooltip") : (this.label = c.label("", 0, 0, h.shape || "callout", null, null, h.useHTML, null, "tooltip").attr({
                    padding: h.padding,
                    r: h.borderRadius
                }),
                this.label.attr({
            ...
            move: function(c, h, e, k) {
                ...
                q.getLabel().attr(d);
                b && (a.clearTimeout(this.tooltipTimeout),
            ...
            getAnchor: function(a, h) {
                var c = this.chart, k = c.pointer, q = c.inverted, d = c.plotTop, b = c.plotLeft, v = 0, f = 0, l, n;
                a = t(a);
                this.followPointer && h ? (void 0 === h.chartX && (h = k.normalize(h)),
                a = [h.chartX - c.plotLeft, h.chartY - d]) : a[0].tooltipPos ? a = a[0].tooltipPos : (F(a, function(a) {
                    l = a.series.yAxis;
                    n = a.series.xAxis;
                ...
                v /= a.length,
                f /= a.length,
                a = [q ? c.plotWidth - f : v, this.shared && !q && 1 < a.length && h ? h.chartY - d : q ? c.plotHeight - v : f]);
                return e(a, Math.round)
            },
            getPosition: function(a, h, e) {
                var c = this.chart, q = this.distance, d = {}, b = c.inverted && e.h || 0, v, f = this.outside, l = f ? C.documentElement.clientWidth - 2 * q : c.chartWidth, p = f ? Math.max(C.body.scrollHeight, C.documentElement.scrollHeight, C.body.offsetHeight, C.documentElement.offsetHeight, C.documentElement.clientHeight) : c.chartHeight, B = c.pointer.chartPosition, D = ["y", p, h, (f ? B.top - q : 0) + e.plotY + c.plotTop, f ? 0 : c.plotTop, f ? p : c.plotTop + c.plotHeight], m = ["x", l, a, (f ? B.left - q : 0) + e.plotX + c.plotLeft, f ? 0 : c.plotLeft, f ? l : c.plotLeft + c.plotWidth], G = !this.followPointer && x(e.ttBelow, !c.inverted === !!e.negative), A = function(a, c, g, m, k, l) {
                    var h = g < m - q
                      , v = m + q + g < c
                      , A = m - q - g;
                    m += q;
                    ...
                    !1 !== A.apply(0, D) ? !1 !== N.apply(0, m) || v || (E(!0),
                    g()) : v ? d.x = d.y = 0 : (E(!0),
                    g())
                };
            ...
            refresh: function(c, h) {
                var e, k = this.options, q, d = c, b, v = {}, f = [];
                ...
                h = b[0],
                q = b[1],
                !v || d.series && d.series.noSharedTooltip ? v = d.getLabelConfig() : (F(d, function(a) {
                    a.setState("hover");
                ...
                this.split ? this.renderSplit(v, t(c)) : (k.style.width || e.css({
                    width: this.chart.spacingBox.width
                }),
                e.attr({
                    text: v && v.join ? v.join("") : v
                }),
                e.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + x(d.colorIndex, l.colorIndex)),
                e.attr({
            ...
            renderSplit: function(c, h) {
                var e = this, k = [], q = this.chart, d = q.renderer, b = !0, v = this.options, f = 0, l, t = this.getLabel(), B = q.plotTop;
                a.isString(c) && (c = [!1, c]);
                F(c.slice(0, h.length + 1), function(a, c) {
                    if (!1 !== a) {
                        ...
                        c.isHeader ? (f = a.height,
                        q.xAxis[0].opposite && (l = !0,
                        B -= f),
                        p = Math.max(0, Math.min(c.plotX + q.plotLeft - p / 2, q.chartWidth + (q.scrollablePixels ? q.scrollablePixels - q.marginRight : 0) - p))) : p = c.plotX + q.plotLeft - x(v.distance, 16) - p;
                        0 > p && (b = !1);
            ...
            getDateFormat: function(a, h, e, k) {
                var c = this.chart.time, d = c.dateFormat("%m-%d %H:%M:%S.%L", h), b, v, f = {
                    millisecond: 15,
                    second: 12,
                    minute: 9,
                    hour: 6,
    ...
    (function(a) {
        ...
        a.Pointer.prototype = {
            ...
            runPointActions: function(c, b) {
                var d = this.chart, k = d.tooltip && d.tooltip.options.enabled ? d.tooltip : void 0, l = k ? k.shared : !1, e = b || d.hoverPoint, h = e && e.series || d.hoverSeries, h = this.getHoverData(e, h, d.series, "touchmove" !== c.type && (!!b || h && h.directTouch && this.isDirectTouch), l, c, {
                ...
                if (e && (e !== d.hoverPoint || k && k.isHidden)) {
                    ...
                    b && k && !k.isHidden && (e = k.getAnchor([{}], c),
                    k.updatePosition({
                        plotX: e[0],
                        plotY: e[1]
                    }));
            ...
            scaleGroups: function(a, b) {
                ...
                u(c.series, function(k) {
                    ...
                    k.markerGroup && (k.markerGroup.attr(d),
            ...
            drag: function(a) {
                var b = this.chart, c = b.options.chart, d = a.chartX, k = a.chartY, e = this.zoomHor, h = this.zoomVert, q = b.plotLeft, m = b.plotTop, f = b.plotWidth, A = b.plotHeight, p, E = this.selectionMarker, g = this.mouseDownX, r = this.mouseDownY, t = c.panKey && a[c.panKey + "Key"];
                E && E.touch || (d < q ? d = q : d > q + f && (d = q + f),
                k < m ? k = m : k > m + A && (k = m + A),
                this.hasDragged = Math.sqrt(Math.pow(g - d, 2) + Math.pow(r - k, 2)),
                10 < this.hasDragged && (p = b.isInsidePlot(g - q, r - m),
                b.hasCartesianSeries && (this.zoomX || this.zoomY) && p && !t && !E && (this.selectionMarker = E = b.renderer.rect(q, m, e ? 1 : f, h ? 1 : A, 0).attr({
            ...
            drop: function(a) {
                ...
                if (this.selectionMarker) {
                    var k = {
                        ...
                        xAxis: [],
                        yAxis: []
                    }, h = this.selectionMarker, q = h.attr ? h.attr("x") : h.x, p = h.attr ? h.attr("y") : h.y, m = h.attr ? h.attr("width") : h.width, G = h.attr ? h.attr("height") : h.height, A;
            ...
            onContainerMouseLeave: function(c) {
                ...
                b && (c.relatedTarget || c.toElement) && (b.pointer.reset(),
            ...
            onContainerClick: function(a) {
                ...
                b.hoverPoint && c.firePointEvent("click", a)) : (x(a, this.getCoordinates(a)),
    ...
    (function(a) {
        ...
        I(a.Pointer.prototype, {
            ...
            pinchTranslateDirection: function(a, e, f, n, y, c, h, p) {
                var k = this.chart, q = a ? "x" : "y", d = a ? "X" : "Y", b = "chart" + d, v = a ? "width" : "height", t = k["plot" + (a ? "Left" : "Top")], l, u, B = p || 1, D = k.inverted, m = k.bounds[a ? "h" : "v"], G = 1 === e.length, A = e[0][b], N = f[0][b], E = !G && e[1][b], g = !G && f[1][b], r;
                f = function() {
            ...
            touch: function(f, n) {
                ...
                1 === f.touches.length ? (f = this.normalize(f),
                (y = t.isInsidePlot(f.chartX - t.plotLeft, f.chartY - t.plotTop)) && !t.openMenu ? (n && this.runPointActions(f),
                "touchmove" === f.type && (n = this.pinchDown,
                u = n[0] ? 4 <= Math.sqrt(Math.pow(n[0].chartX - f.chartX, 2) + Math.pow(n[0].chartY - f.chartY, 2)) : !1),
                e(u, !0) && this.pinch(f)) : n && this.reset()) : 2 === f.touches.length && this.pinch(f)
            },
    ...
    (function(a) {
        ...
        if (!a.hasTouch && (t.PointerEvent || t.MSPointerEvent)) {
            var y = {}
              ...
              , p = function(c, q, d, b) {
                "touch" !== c.pointerType && c.pointerType !== c.MSPOINTER_TYPE_TOUCH || !F[a.hoverChartIndex] || (b(c),
    ...
    (function(a) {
        ...
        a.Legend.prototype = {
            ...
            colorizeItem: function(a, c) {
                ...
                h && (f && h.isMarker && (p = a.pointAttribs(),
                c || (p.stroke = p.fill = l)),
                h.attr(p));
            ...
            positionCheckboxes: function() {
                var a = this.group && this.group.alignAttr, c, d = this.clipHeight || this.legendHeight, b = this.titleHeight;
                a && (c = a.translateY,
                f(this.allItems, function(e) {
                    var h = e.checkbox, k;
                    h && (k = c + b + h.y + (this.scrollOffset || 0) + 3,
                    F(h, {
            ...
            layoutItem: function(a) {
                ...
                b && this.itemX - d + c > p && (this.itemX = d,
                ...
                b ? this.itemX += c : (this.itemY += l + h + e,
            ...
            proximatePositions: function() {
                ...
                f(this.allItems, function(b) {
                    var e, k;
                    e = d;
                    b.xAxis && b.points && (b.xAxis.options.reversed && (e = !e),
                    e = a.find(e ? b.points : b.points.slice(0).reverse(), function(b) {
            ...
            render: function() {
                var a = this.chart, h = a.renderer, d = this.group, b, e, p, l = this.box, n = this.options, B = this.padding;
                this.itemX = B;
                ...
                this.legendHeight = p;
                e && (h = a.spacingBox,
                /(lth|ct|rth)/.test(this.getAlignment()) && (h = t(h, {
            ...
            handleOverflow: function(a) {
                var c = this, d = this.chart, b = d.renderer, h = this.options, e = h.y, l = this.padding, d = d.spacingBox.height + ("top" === h.verticalAlign ? -e : e) - l, e = h.maxHeight, k, p = this.clipRect, n = h.navigation, m = w(n.animation, !0), G = n.arrowSize || 12, A = this.nav, t = this.pages, E, g = this.allItems, r = function(a) {
                    "number" === typeof a ? p.attr({
                        height: a
                    }) : p && (c.clipRect = p.destroy(),
                    c.contentGroup.clip());
                ...
                e && (d = Math.min(d, e));
                t.length = 0;
                a > d && !1 !== n.enabled ? (this.clipHeight = k = Math.max(d - 20 - this.titleHeight - l, 0),
                ...
                f(g, function(a, b) {
                    ...
                    a.pageIx = m - 1;
                    E && (g[b - 1].pageIx = m - 1);
                    b === g.length - 1 && c + d - t[m - 1] > k && (t.push(c),
                    a.pageIx = m);
                    c !== E && (E = c)
                }),
                p || (p = c.clipRect = b.clipRect(0, l, 9999, 0),
                c.contentGroup.clip(p)),
                r(k),
                A || (this.nav = A = b.g().attr({
                    zIndex: 1
                }).add(this.group),
                this.up = b.symbol("triangle", 0, 0, G, G).on("click", function() {
                    c.scroll(-1, m)
                }).add(A),
                this.pager = b.text("", 15, 10).addClass("highcharts-legend-navigation").css(n.style).add(A),
                this.down = b.symbol("triangle-down", 0, 0, G, G).on("click", function() {
                    c.scroll(1, m)
                }).add(A)),
                c.scroll(0),
                a = d) : A && (r(),
        ...
        a.LegendSymbolMixin = {
            ...
            drawLineMarker: function(a) {
                ...
                d && !1 !== d.enabled && b && (c = Math.min(w(d.radius, e), e),
                0 === this.symbol.indexOf("url") && (d = t(d, {
                    width: h,
                    height: h
                }),
                c = 0),
                this.legendSymbol = d = l.symbol(this.symbol, b / 2 - c, a - c, 2 * c, 2 * c, d).addClass("highcharts-point").add(f),
                d.isMarker = !0)
            }
        };
    ...
    (function(a) {
        ...
        p(O.prototype, {
            ...
            init: function(b, c) {
                var d, g, m = b.series, h = b.plotOptions || {};
                q(this, "init", {
                    args: arguments
                }, function() {
                    b.series = null;
            ...
            redraw: function(b) {
                q(this, "beforeRedraw");
                var c = this.axes, d = this.series, g = this.pointer, m = this.legend, e = this.userOptions.legend, l = this.isDirtyLegend, f, A, k = this.hasCartesianSeries, r = this.isDirtyBox, G, v = this.renderer, H = v.isHidden(), E = [];
                ...
                h(d, function(a) {
                    ...
                    l = !0) : e && (e.labelFormatter || e.labelFormat) && (l = !0));
                    a.isDirtyData && q(a, "updatedData")
                });
                l && m && m.options.enabled && (m.render(),
            ...
            layOutTitles: function(a) {
                ...
                h(["title", "subtitle"], function(a) {
                    ...
                    m.floating || m.verticalAlign || (b = Math.ceil(b + c.getBBox(m.useHTML).height)))
                }, this);
            ...
            getChartSize: function() {
                ...
                this.chartWidth = Math.max(0, d || this.containerWidth || 300);
                this.chartHeight = Math.max(0, a.relativeLength(b, this.chartWidth) || (1 < this.containerHeight ? this.containerHeight : 168))
            },
            temporaryDisplay: function(b) {
                ...
                if (b)
                    ...
                    for (; c && c.style; ) {
                        f.body.contains(c) || c.parentNode || (c.hcOrigDetached = !0,
            ...
            getContainer: function() {
                var c, d = this.options, g = d.chart, m, h;
                c = this.renderTo;
                var e = a.uniqueKey(), l;
            ...
            setChartSize: function(a) {
                var b = this.inverted, c = this.renderer, g = this.chartWidth, d = this.chartHeight, m = this.options.chart, e = this.spacing, l = this.clipOffset, f, A, k, r;
            ...
            drawChartBox: function() {
                ...
                u = "animate";
                m || (u = "attr",
                this.plotBackground = m = b.rect().addClass("highcharts-plot-background").add());
                m[u](n);
                m.attr({
                    fill: A || "none"
                }).shadow(a.plotShadow);
                ...
                u = "animate";
                h || (u = "attr",
                this.plotBorder = h = b.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                h.attr({
            ...
            propFromSeries: function() {
                var a = this, b = a.options.chart, c, g = a.options.series, d, m;
            ...
            linkSeries: function() {
                ...
                h(b, function(b) {
                    ...
                    J(c) && (c = ":previous" === c ? a.series[b.index - 1] : a.get(c)) && c.linkedParent !== b && (c.linkedSeries.push(b),
                    b.linkedParent = c,
            ...
            render: function() {
                var a = this.axes, b = this.renderer, c = this.options, g, d, m;
                this.setTitle();
            ...
            destroy: function() {
                var b = this, c = b.axes, g = b.series, d = b.container, m, e = d && d.parentNode;
                q(b, "destroy");
    ...
    (function(a) {
        ...
        C(F, "afterSetChartSize", function(n) {
            ...
            (f = f && f.minWidth) && !this.renderer.forExport && (this.scrollablePixels = f = Math.max(0, f - this.chartWidth)) && (this.plotWidth += f,
            this.clipBox.width += f,
            n.skipAxes || I(this.axes, function(e) {
        ...
        F.prototype.applyFixed = function() {
            ...
            u && (e = this.options.chart.scrollablePlotArea,
    ...
    (function(a) {
        ...
        a.Point.prototype = {
            init: function(a, c, e) {
                ...
                e = a.colorCounter,
                a.colorCounter++,
                a.colorCounter === c && (a.colorCounter = 0)) : e = a.colorIndex;
            ...
            optionsToObject: function(c) {
                ...
                if (x(c) || null === c)
                    ...
                    for (!f && c.length > b && (h = typeof c[0],
                    "string" === h ? e.name = c[0] : "number" === h && (e.x = c[0]),
                    v++); n < b; )
                        f && void 0 === c[v] || (0 < d[n].indexOf(".") ? a.Point.prototype.setNestedProperty(e, c[v], d[n]) : e[d[n]] = c[v]),
                        v++,
                        n++;
                else
                    "object" === typeof c && (e = c,
            ...
            getZone: function() {
                var a = this.series, c = a.zones, a = a.zoneAxis || "y", e = 0, f;
                for (f = c[e]; this[a] >= f.value; )
                    f = c[++e];
        ...
        a.Series = a.seriesType("line", null, {
            ...
            bindAxes: function() {
                ...
                t(b.axisTypes || [], function(m) {
                    t(d[m], function(a) {
                        e = a.options;
                        if (c[m] === e.index || void 0 !== c[m] && c[m] === e.id || void 0 === c[m] && 0 === e.index)
                            b.insert(a.series),
                            b[m] = a,
                            a.isDirty = !0
                    });
            ...
            autoIncrement: function() {
                var a = this.options, b = this.xIncrement, c, d = a.pointIntervalUnit, e = this.chart.time, b = v(b, a.pointStart, 0);
            ...
            getCyclic: function(a, b, c) {
                var d, e = this.chart, g = this.userOptions, m = a + "Index", h = a + "Counter", f = c ? c.length : v(e.options.chart[a + "Count"], e[a + "Count"]);
                b || (d = v(g[m], g["_" + m]),
                x(d) || (e.series.length || (e[h] = 0),
                g["_" + m] = d = e[h] % f,
                e[h] += 1),
                c && (b = c[d]));
                void 0 !== d && (this[m] = d);
            ...
            updateData: function(b) {
                ...
                t(b, function(b) {
                    ...
                    k(g) && (g = a.inArray(g, this.xData, h),
                    -1 === g || d[g].touched ? e.push(b) : b !== c.data[g] ? (d[g].update(b, !1, null, !1),
                    d[g].touched = !0,
                    f && (h = g + 1)) : d[g] && (d[g].touched = !0),
                    m = !0)
                }, this);
                if (m)
                    for (b = d.length; b--; )
            ...
            setData: function(b, c, d, e) {
                var m = this, g = m.points, h = g && g.length || 0, f, l = m.options, A = m.chart, G = null, n = m.xAxis, B = l.turboThreshold, u = this.xData, D = this.yData, y = (f = m.pointArrayMap) && f.length, N;
                b = b || [];
                f = b.length;
                c = v(c, !0);
            ...
            processData: function(b) {
                var c = this.xData, d = this.yData, e = c.length, m;
                m = 0;
                var g, h, f = this.xAxis, l, k = this.options;
                l = k.cropThreshold;
                var p = this.getExtremesFromAll || k.getExtremesFromAll, q = this.isCartesian, k = f && f.val2lin, v = f && f.isLog, n = this.requireSorting, B, t;
                if (q && !this.isDirty && !f.isDirty && !this.yAxis.isDirty && !b)
                    return !1;
                f && (b = f.getExtremes(),
                B = b.min,
                t = b.max);
                q && this.sorted && !p && (!l || e > l || this.forceCrop) && (c[e - 1] < B || c[0] > t ? (c = [],
                d = []) : this.yData && (c[0] < B || c[e - 1] > t) && (m = this.cropData(this.xData, this.yData, B, t),
                c = m.xData,
                d = m.yData,
                m = m.start,
                g = !0));
                for (l = c.length || 1; --l; )
                    ...
                    0 < e && (void 0 === h || e < h) ? h = e : 0 > e && n && (a.error(15),
                    n = !1);
                this.cropped = g;
                this.cropStart = m;
            ...
            generatePoints: function() {
                var a = this.options, b = a.data, c = this.data, d, e = this.processedXData, g = this.processedYData, h = this.pointClass, f = e.length, k = this.cropStart || 0, p, q = this.hasGroupedData, a = a.keys, v, n = [], B;
                c || q || (c = [],
                c.length = b.length,
                c = this.data = c);
                ...
                for (B = 0; B < f; B++)
                    p = k + B,
                    q ? (v = (new h).init(this, [e[B]].concat(l(g[B]))),
                    v.dataGroup = this.groupMap[B],
                    v.dataGroup.options && (v.options = v.dataGroup.options,
                    y(v, v.dataGroup.options))) : (v = c[p]) || void 0 === b[p] || (c[p] = v = (new h).init(this, b[p], e[B])),
                    v && (v.index = p,
                    n[B] = v);
                this.options.keys = a;
                if (c && (f !== (d = c.length) || q))
            ...
            getExtremes: function(a) {
                ...
                var m = d.min, h = d.max, f, l, q = this.requireSorting ? 1 : 0, v, B;
                a = a || this.stackedYData || this.processedYData || [];
                d = a.length;
                for (B = 0; B < d; B++)
                    if (l = c[B],
                    v = a[B],
                    f = (k(v, !0) || p(v)) && (!b.positiveValuesOnly || v.length || 0 < v),
                    l = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[B + q] || l) >= m && (c[B - q] || l) <= h,
                    f && l)
                        if (f = v.length)
                            for (; f--; )
            ...
            translate: function() {
                ...
                this.generatePoints();
                var a = this.options, b = a.stacking, d = this.xAxis, e = d.categories, h = this.yAxis, g = this.points, l = g.length, p = !!this.modifyValue, q = a.pointPlacement, B = "between" === q || k(q), n = a.threshold, t = a.startFromThreshold ? n : 0, u, D, y, w, J = Number.MAX_VALUE;
                "between" === q && (q = .5);
                ...
                for (a = 0; a < l; a++) {
                    var L = g[a]
                      ...
                      , F = L.y;
                    D = L.low;
                    var I = b && h.stacks[(this.negStacks && F < (t ? 0 : n) ? "-" : "") + this.stackKey], K;
                    h.positiveValuesOnly && null !== F && 0 >= F && (L.isNull = !0);
                    L.plotX = u = f(Math.min(Math.max(-1E5, d.translate(C, 0, 0, 0, 1, q, "flags" === this.type)), 1E5));
                    b && this.visible && !L.isNull && I && I[C] && (w = this.getStackIndicator(w, C, this.index),
                    K = I[C],
                    F = K.points[w.key],
                    D = F[0],
                    F = F[1],
                    ...
                    L.isNull || (void 0 !== y && (J = Math.min(J, Math.abs(u - y))),
                    y = u);
            ...
            setClip: function(a) {
                ...
                f || (a && (m.width = 0,
                e && (m.x = b.plotSizeX),
                b[h + "m"] = l = d.clipRect(e ? b.plotSizeX + 99 : -99, e ? -b.plotLeft : -b.plotTop, 99, e ? b.chartWidth : b.chartHeight)),
                b[h] = f = d.clipRect(m),
                f.count = {
                    length: 0
                });
                a && !f.count[this.index] && (f.count[this.index] = !0,
                f.count.length += 1);
                !1 !== c.clip && (this.group.clip(a || g ? f : b.clipRect),
                this.markerGroup.clip(l),
                this.sharedClipKey = h);
                a || (f.count[this.index] && (delete f.count[this.index],
                --f.count.length),
                0 === f.count.length && h && b[h] && (g || (b[h] = b[h].destroy()),
            ...
            drawPoints: function() {
                var a = this.points, b = this.chart, c, d, e, g, h = this.options.marker, f, l, k, p = this[this.specialGroup] || this.markerGroup, q, n = v(h.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx >= h.enabledThreshold * h.radius);
                if (!1 !== h.enabled || this._hasPointMarkers)
                    for (c = 0; c < a.length; c++)
                        ...
                        k = d.isInside,
                        e && !d.isNull ? (e = v(f.symbol, this.symbol),
                        q = this.markerAttribs(d, d.selected && "select"),
                        g ? g[k ? "show" : "hide"](!0).animate(q) : k && (0 < q.width || d.hasImage) && (d.graphic = g = b.renderer.symbol(e, q.x, q.y, q.width, q.height, l ? f : h).add(p)),
            ...
            markerAttribs: function(a, b) {
                ...
                g = v(b && b.radius, c && c.radius, g + (c && c.radiusPlus || 0)));
            ...
            pointAttribs: function(a, b) {
                ...
                d = v(b.lineWidth, c.lineWidth, d + v(b.lineWidthPlus, c.lineWidthPlus, 0)),
            ...
            destroy: function() {
                var d = this, e = d.chart, h = /AppleWebKit\/533/.test(D.navigator.userAgent), f, l, g = d.data || [], k, p;
                c(d, "destroy");
                J(d);
                t(d.axisTypes || [], function(a) {
                    (p = d[a]) && p.series && (w(p.series, d),
                ...
                b(d, function(a, b) {
                    a instanceof L && !a.survive && (f = h && "group" === b ? "hide" : "destroy",
                    a[f]())
                });
            ...
            getGraphPath: function(a, b, c) {
                var d = this, e = d.options, g = e.step, h, m = [], f = [], l;
                a = a || d.points;
                ...
                t(a, function(h, k) {
                    ...
                    h.isNull && !x(b) && 0 < k ? l = !e.connectNulls : h.isNull && !b ? l = !0 : (0 === k || l ? k = ["M", h.plotX, h.plotY] : d.getPointSpline ? k = d.getPointSpline(a, h, k) : g ? (k = 1 === g ? ["L", q.plotX, p] : 2 === g ? ["L", (q.plotX + r) / 2, q.plotY, "L", (q.plotX + r) / 2, p] : ["L", r, q.plotY],
                    k.push("L", r, p)) : k = ["L", r, p],
                    f.push(h.x),
                    g && (f.push(h.x),
                    2 === g && f.push(h.x)),
                    m.push.apply(m, k),
            ...
            drawGraph: function() {
                ...
                t(d, function(d, g) {
                    var e = d[0]
                      , h = a[e];
                    h ? (h.endX = a.preventGraphAnimation ? null : c.xMap,
                    h.animate({
                        d: c
                    ...
                    d[3] ? h.dashstyle = d[3] : "square" !== b.linecap && (h["stroke-linecap"] = h["stroke-linejoin"] = "round"),
            ...
            applyZones: function() {
                var a = this, b = this.chart, c = b.renderer, d = this.zones, e, g, h = this.clips || [], f, l = this.graph, k = this.area, p = Math.max(b.chartWidth, b.chartHeight), q = this[(this.zoneAxis || "y") + "Axis"], n, B, u = b.inverted, D, y, w, x, J = !1;
                d.length && (l || k) && q && void 0 !== q.min && (B = q.reversed,
                D = q.horiz,
                ...
                t(d, function(d, m) {
                    ...
                    h[m] ? h[m].animate(f) : (h[m] = c.clipRect(f),
            ...
            render: function() {
                var a = this, b = a.chart, d, e = a.options, h = !!a.animate && b.renderer.isSVG && F(e.animation).duration, g = a.visible ? "inherit" : "hidden", f = e.zIndex, l = a.hasRendered, k = b.seriesGroup, p = b.inverted;
            ...
            searchKDTree: function(a, b) {
                function c(a, b, f, l) {
                    var m = b.point, k = d.kdAxisArray[f % l], p, q, r = m;
                    ...
                    b[p] && (p = c(a, b[p], f + 1, l),
                    r = p[h] < r[h] ? p : m);
                    b[q] && Math.sqrt(k * k) < r[h] && (a = c(a, b[q], f + 1, l),
                    r = a[h] < r[h] ? a : r);
                    return r
                }
                var d = this
    ...
    (function(a) {
        ...
        C.prototype.buildStacks = function() {
            var a = this.series, c = t(this.options.reversedStacks, !0), e = a.length, f;
            if (!this.isXAxis) {
        ...
        w.prototype.setStackedPoints = function() {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var e = this.processedXData, c = this.processedYData, h = [], f = c.length, k = this.options, q = k.threshold, d = t(k.startFromThreshold && q, 0), b = k.stack, k = k.stacking, v = this.stackKey, u = "-" + v, l = this.negStacks, w = this.yAxis, B = w.stacks, D = w.oldStacks, m, G, A, x, E, g, r;
                w.stacksTouched += 1;
                for (E = 0; E < f; E++)
                    g = e[E],
                    r = c[E],
                    ...
                    A = (G = l && r < (d ? 0 : q)) ? u : v,
                    B[A] || (B[A] = {}),
                    B[A][g] || (D[A] && D[A][g] ? (B[A][g] = D[A][g],
                    B[A][g].total = null) : B[A][g] = new a.StackItem(w,w.options.stackLabels,G,g,b)),
                    A = B[A][g],
                    null !== r ? (A.points[x] = A.points[this.index] = [t(A.cumulative, d)],
                    n(A.cumulative) || (A.base = x),
                    A.touched = w.stacksTouched,
                    0 < m.index && !1 === this.singleStacks && (A.points[x][0] = A.points[this.index + "," + g + ",0"][0])) : A.points[x] = A.points[this.index] = null,
                    "percent" === k ? (G = G ? v : u,
                    l && B[G] && B[G][g] ? (G = B[G][g],
                    A.total = G.total = Math.max(G.total, A.total) + Math.abs(r) || 0) : A.total = I(A.total + (Math.abs(r) || 0))) : A.total = I(A.total + (r || 0)),
                    A.cumulative = t(A.cumulative, d) + (r || 0),
                    null !== r && (A.points[x].push(A.cumulative),
                    h[E] = A.cumulative);
        ...
        w.prototype.modifyStacks = function() {
            var a = this, c = a.stackKey, h = a.yAxis.stacks, f = a.processedXData, k, q = a.options.stacking;
    ...
    (function(a) {
            ...
            update: function(a, b, h, f) {
                ...
                u("xAxis yAxis zAxis series colorAxis pane".split(" "), function(b) {
                    ...
                    u(L(a[b]), function(a, d) {
                        (d = e(a.id) && l.get(a.id) || l[b][c ? c[d] : d]) && d.coll === b && (d.update(a, !1),
                        h && (d.touched = !0));
                        if (!d && h)
                            if ("series" === b)
        ...
        t(b.prototype, {
            update: function(a, b, c, e) {
                function f() {
                    ...
                    h(a, !0) && (g && g.element && a && a.marker && void 0 !== a.marker.symbol && (l.graphic = g.destroy()),
                ...
                var l = this, m = l.series, g = l.graphic, k, q = m.chart, p = m.options;
                b = d(b, !0);
        ...
        t(v.prototype, {
            addPoint: function(a, b, c, e) {
                var h = this.options, f = this.data, l = this.chart, g = this.xAxis, g = g && g.hasNames && g.names, m = h.data, k, p, q = this.xData, v, n;
                b = d(b, !0);
                k = {
                    series: this
                };
            ...
            update: function(b, c) {
                var e = this, h = e.chart, f = e.userOptions, l = e.oldType || e.type, q = b.type || f.type || h.options.chart.type, g = J[l].prototype, p, v = ["group", "markerGroup", "dataLabelsGroup"], n = ["navigatorSeries", "baseSeries"], B = e.finishedAnimating && {
                    animation: !1
                }, D = ["data", "name", "turboThreshold"], x = a.keys(b), L = 0 < x.length;
                u(x, function(a) {
                    -1 === y(a, D) && (L = !1)
                });
                if (L)
    ...
    (function(a) {
        ...
        e("area", "line", {
            ...
            getStackPoints: function(e) {
                var f = [], t = [], u = this.xAxis, y = this.yAxis, c = y.stacks[this.stackKey], h = {}, p = this.index, k = y.series, q = k.length, d, b = n(y.options.reversedStacks, !0) ? 1 : -1, v;
                e = e || this.points;
                        ...
                        if (h[a] && !h[a].isNull)
                            ...
                            F([-1, 1], function(f) {
                                ...
                                if (u)
                                    for (v = p; 0 <= v && v < q; )
                                        k = u.points[v],
                                        k || (v === p ? h[a][l] = !0 : d[v] && (n = c[a].points[v]) && (m -= n[1] - n[0])),
                                        v += b;
            ...
            getGraphPath: function(a) {
                var e = f.prototype.getGraphPath, t = this.options, u = t.stacking, y = this.yAxis, c, h, p = [], k = [], q = this.index, d, b = y.stacks[this.stackKey], v = t.threshold, J = y.getThreshold(t.threshold), l, t = t.connectNulls || "percent" === u, L = function(c, e, h) {
                    var f = a[c];
                    c = u && b[f.x].points[q];
                    var l = f[h + "Null"] || 0;
                    h = f[h + "Cliff"] || 0;
            ...
            drawGraph: function() {
                ...
                F(w, function(f) {
                    var c = f[0]
                      , h = a[c];
                    h ? (h.endX = a.preventGraphAnimation ? null : e.xMap,
                    h.animate({
                        d: e
        ...
        a("spline", "line", {}, {
            getPointSpline: function(a, I, n) {
                ...
                if (u && !u.isNull && !1 !== u.doCurve && !I.isCliff && n && !n.isNull && !1 !== n.doCurve && !I.isCliff) {
                    ...
                    t += c;
                    y += c;
                    t > a && t > e ? (t = Math.max(a, e),
                    y = 2 * e - t) : t < a && t < e && (t = Math.min(a, e),
                    y = 2 * e - t);
                    y > n && y > e ? (y = Math.max(n, e),
                    t = 2 * e - y) : y < n && y < e && (y = Math.min(n, e),
                    t = 2 * e - y);
                    I.rightContX = w;
                    I.rightContY = y
                }
    ...
    (function(a) {
        ...
        w("column", "line", {
            ...
            getColumnMetrics: function() {
                var a = this, e = a.options, f = a.xAxis, k = a.yAxis, q = f.options.reversedStacks, q = f.reversed && !q || !f.reversed && q, d, b = {}, v = 0;
                !1 === e.grouping ? v = 1 : I(a.chart.series, function(c) {
                    var e = c.options, f = c.yAxis, h;
                    c.type !== a.type || !c.visible && a.chart.options.chart.ignoreHiddenSeries || k.len !== f.len || k.pos !== f.pos || (e.stacking ? (d = c.stackKey,
                    void 0 === b[d] && (b[d] = v++),
                    h = b[d]) : !1 !== e.grouping && (h = v++),
                    c.columnIndex = h)
                });
            ...
            translate: function() {
                ...
                I(a.points, function(c) {
                    var h = x(c.yBottom, b), k = 999 + Math.abs(h), p = l, k = Math.min(Math.max(-k, c.plotY), q.len + k), n = c.plotX + B, t = u, g = Math.min(k, h), r, w = Math.max(k, h) - g;
                    v && Math.abs(w) < v && (w = v,
            ...
            pointAttribs: function(a, e) {
                var c = this.options, f, h = this.pointAttrToOptions || {};
                ...
                e && (a = u(c.states[e], a.options.states && a.options.states[e] || {}),
                e = a.brightness,
            ...
            drawPoints: function() {
                var a = this, f = this.chart, p = a.options, k = f.renderer, q = p.animationLimit || 250, d;
                I(a.points, function(b) {
                    ...
                    if (e(b.plotY) && null !== b.y) {
                        ...
                        if (c)
                            ...
                            b.graphic = c = k[b.shapeType](d).add(b.group || a.group);
            ...
            animate: function(a) {
                var c = this, e = this.yAxis, f = c.options, q = this.chart.inverted, d = {}, b = q ? "translateX" : "translateY", v;
                y && (a ? (d.scaleY = .001,
                a = Math.min(e.pos + e.len, Math.max(e.pos, e.toPixels(f.threshold))),
                q ? d.translateX = a - e.len : d.translateY = a,
                c.group.attr(d)) : (v = c.group.attr(b),
                c.group.animate({
                    scaleY: 1
    ...
    (function(a) {
        ...
        a.CenteredSeriesMixin = {
            getCenter: function() {
                var a = this.options, e = this.chart, u = 2 * (a.slicedOffset || 0), x = e.plotWidth - 2 * u, e = e.plotHeight - 2 * u, t = a.center, t = [I(t[0], "50%"), I(t[1], "50%"), a.size || "100%", a.innerSize || 0], w = Math.min(x, e), y, c;
                for (y = 0; 4 > y; ++y)
                    c = t[y],
                    a = 2 > y || 2 === y && /%$/.test(c),
    ...
    (function(a) {
        ...
        c("pie", "line", {
            ...
            updateTotals: function() {
                var a, c = 0, e = this.points, d = e.length, b, f = this.options.ignoreHiddenPoint;
                for (a = 0; a < d; a++)
                    b = e[a],
            ...
            translate: function(a) {
                this.generatePoints();
                var c = 0, f = this.options, d = f.slicedOffset, b = d + (f.borderWidth || 0), h, n, l, p = e(f.startAngle, f.endAngle), u = this.startAngleRad = p.start, p = (this.endAngleRad = p.end) - u, w = this.points, m, x = f.dataLabels.distance, f = f.ignoreHiddenPoint, A, y = w.length, E;
            ...
            drawGraph: null,
            drawPoints: function() {
                var a = this, c = a.chart.renderer, e, d, b, h, t = a.options.shadow;
                ...
                n(a.points, function(l) {
                    ...
                    if (l.isNull)
                        ...
                        d ? d.setRadialReference(a.center).attr(b).animate(f(h, e)) : (l.graphic = d = c[l.shapeType](h).setRadialReference(a.center).attr(e).add(a.group),
                        d.attr(b).attr({
                            "stroke-linejoin": "round"
                        }).shadow(t, k));
                        d.attr({
    ...
    (function(a) {
        ...
        a.distribute = function(b, c, d) {
            ...
            for (b = u(b, function(a) {
                ...
                for (f = b.length; f--; )
                    h = b[f],
                    v = (Math.min.apply(0, h.targets) + Math.max.apply(0, h.targets)) / 2,
                    h.pos = Math.min(Math.max(0, v - h.size * h.align), c - h.size);
                f = b.length;
                for (h = !1; f--; )
                    0 < f && b[f - 1].pos + b[f - 1].size > b[f].pos && (b[f - 1].size += b[f].size,
                    b[f - 1].targets = b[f - 1].targets.concat(b[f].targets),
                    b[f - 1].align = .5,
                    b[f - 1].pos + b[f - 1].size > c && (b[f - 1].pos = c - b[f - 1].size),
                    b.splice(f, 1),
                    h = !0)
            }
            q.push.apply(q, m);
            ...
            p(b, function(b) {
                ...
                if (p(b.targets, function() {
                    ...
                    if (Math.abs(q[f].pos - q[f].target) > d)
                        return n(q.slice(0, f + 1), function(a) {
                            delete a.pos
                        }),
                        q.reducedLen = (q.reducedLen || c) - .1 * c,
                        q.reducedLen > .1 * c && a.distribute(q, c, d),
                        !0;
                    e += q[f].size;
                    f++
                }))
        ...
        c.prototype.drawDataLabels = function() {
            ...
            var f = this, h = f.chart, k = f.options, p = k.dataLabels, t = f.points, m, y = f.hasRendered || 0, A, F = w(p.defer, !!k.animation), E = h.renderer, p = c(c(h.options.plotOptions && h.options.plotOptions.series && h.options.plotOptions.series.dataLabels, h.options.plotOptions && h.options.plotOptions[f.type] && h.options.plotOptions[f.type].dataLabels), p);
            if (q(p) || p.enabled || f._hasPointLabels)
                A = f.plotGroup("dataLabelsGroup", "data-labels", F && !y ? "hidden" : "visible", p.zIndex || 6),
                F && (A.attr({
                    opacity: +y
                }),
                ...
                n(t, function(g) {
                    ...
                    n(m, function(c, d) {
                        var l = c.enabled && !g.isNull && b(g, c), m, n, q, r, p = g.dataLabels ? g.dataLabels[d] : g.dataLabel, v = g.connectors ? g.connectors[d] : g.connector, t = !p;
                        l && (m = g.getLabelConfig(),
                        n = c[g.formatPrefix + "Format"] || c.format,
                        m = I(n) ? e(n, m, h.time) : (c[g.formatPrefix + "Formatter"] || c.formatter).call(m, c),
                        n = c.style,
                        q = c.rotation,
                        n.color = w(c.color, n.color, f.color, "#000000"),
                        "contrast" === n.color && (g.contrastColor = E.getContrast(g.color || f.color),
                        n.color = c.inside || 0 > w(c.distance, g.labelDistance) || k.stacking ? g.contrastColor : "#000000"),
                        ...
                        !p || l && I(m) ? l && I(m) && (p ? r.text = m : (g.dataLabels = g.dataLabels || [],
                        p = g.dataLabels[d] = q ? E.text(m, 0, -9999).addClass("highcharts-data-label") : E.label(m, 0, -9999, c.shape, null, null, c.useHTML, null, "data-label"),
                        d || (g.dataLabel = p),
                        p.addClass(" highcharts-data-label-color-" + g.colorIndex + " " + (c.className || "") + (c.useHTML ? " highcharts-tracker" : ""))),
                        p.options = c,
                        p.attr(r),
                        p.css(n).shadow(c.shadow),
                        p.added || p.add(A),
                        f.alignDataLabel(g, p, c, null, t)) : (g.dataLabel = g.dataLabel.destroy(),
                        g.dataLabels && (1 === g.dataLabels.length ? delete g.dataLabels : delete g.dataLabels[d]),
                        d || delete g.dataLabel,
                        v && (g.connector = g.connector.destroy(),
                        g.connectors && (1 === g.connectors.length ? delete g.connectors : delete g.connectors[d])))
                    })
                });
        ...
        c.prototype.alignDataLabel = function(a, c, d, e, h) {
            ...
            k = (p + 720) % 360,
            k = 180 < k && 360 > k,
            "left" === g ? m.y -= k ? n.height : 0 : "center" === g ? (m.x -= n.width / 2,
            m.y -= n.height / 2) : "right" === g && (m.x -= n.width,
            m.y -= k ? 0 : n.height),
            c.placed = !0,
            c.alignAttr = m) : (c.align(d, null, e),
            m = c.alignAttr),
            v && 0 <= e.height ? a.isLabelJustified = this.justifyDataLabel(c, d, m, n, e, h) : w(d.crop, !0) && (r = b.isInsidePlot(m.x, m.y) && b.isInsidePlot(m.x + n.width, m.y + n.height)),
            d.shape && !p))
                c[h ? "attr" : "animate"]({
        ...
        c.prototype.justifyDataLabel = function(a, c, d, e, f, h) {
            var b = this.chart, l = c.align, k = c.verticalAlign, n, q, p = a.box ? 0 : a.padding || 0;
            n = d.x + p;
            0 > n && ("right" === l ? c.align = "left" : c.x = -n,
            q = !0);
            n = d.x + e.width - p;
            n > b.plotWidth && ("left" === l ? c.align = "right" : c.x = b.plotWidth - n,
            q = !0);
            n = d.y + p;
            0 > n && ("bottom" === k ? c.verticalAlign = "top" : c.y = -n,
            q = !0);
            n = d.y + e.height - p;
            n > b.plotHeight && ("top" === k ? c.verticalAlign = "bottom" : c.y = b.plotHeight - n,
            q = !0);
            q && (a.placed = !h,
            a.align(c, null, f));
            return q
        ...
        h.pie && (h.pie.prototype.drawDataLabels = function() {
            var b = this, d = b.data, e, f = b.chart, h = b.options.dataLabels, k = w(h.connectorPadding, 10), q = w(h.connectorWidth, 1), m = f.plotWidth, p = f.plotHeight, t = Math.round(f.chartWidth / 3), u, x = b.center, g = x[2] / 2, r = x[1], y, C, H, K, Q = [[], []], z, P, T, S, U = [0, 0, 0, 0];
            ...
            n(d, function(a) {
                ...
                !I(h.style.width) && !I(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > t && (a.dataLabel.css({
                    width: .7 * t
                }),
            ...
            n(Q, function(c, d) {
                var l, q, t = c.length, v = [], u;
                if (t)
                    for (b.sortByAngle(c, d - .5),
                    0 < b.maxLabelDistance && (l = Math.max(0, r - g - b.maxLabelDistance),
                    q = Math.min(r + g + b.maxLabelDistance, f.plotHeight),
                    n(c, function(a) {
                        0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, r - g - a.labelDistance),
                        a.bottom = Math.min(r + g + a.labelDistance, f.plotHeight),
                    ...
                    S = 0; S < t; S++)
                        ...
                        P = l = H[1],
                        v && I(e.distributeBox) && (void 0 === e.distributeBox.pos ? T = "hidden" : (K = e.distributeBox.size,
                        P = e.top + e.distributeBox.pos)),
                        delete e.positionIndex,
                        z = h.justify ? x[0] + (d ? -1 : 1) * (g + e.labelDistance) : b.getX(P < e.top + 2 || P > e.bottom - 2 ? l : P, d, e),
                        y._attr = {
                            visibility: T,
                            align: H[6]
                        },
                        ...
                        H.x = z,
                        H.y = P,
                        w(h.crop, !0) && (C = y.getBBox().width,
                        l = null,
                        z - C < k && 1 === d ? (l = Math.round(C - z + k),
                        U[3] = Math.max(l, U[3])) : z + C > m - k && 0 === d && (l = Math.round(z + C - m + k),
                        U[1] = Math.max(l, U[1])),
                        0 > P - K / 2 ? U[0] = Math.max(Math.round(-P + K / 2), U[0]) : P + K / 2 > p && (U[2] = Math.max(Math.round(P + K / 2 - p), U[2])),
                        y.sideOverflow = l)
            }),
            0 === F(U) || this.verifyDataLabelOverflow(U)) && (this.placeDataLabels(),
            q && n(this.points, function(a) {
                ...
                if ((y = a.dataLabel) && y._pos && a.visible && 0 < a.labelDistance) {
                    ...
                    if (c = !u)
                        a.connector = u = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex + (a.className ? " " + a.className : "")).add(b.dataLabelsGroup),
                        u.attr({
                            "stroke-width": q,
        ...
        h.pie.prototype.verifyDataLabelOverflow = function(a) {
            var b = this.center, c = this.options, d = c.center, e = c.minSize || 80, f, h = null !== c.size;
            h || (null !== d[0] ? f = Math.max(b[2] - Math.max(a[1], a[3]), e) : (f = Math.max(b[2] - a[1] - a[3], e),
            b[0] += (a[3] - a[1]) / 2),
            null !== d[1] ? f = Math.max(Math.min(f, b[2] - Math.max(a[0], a[2])), e) : (f = Math.max(Math.min(f, b[2] - a[0] - a[2]), e),
            b[1] += (a[0] - a[2]) / 2),
            f < b[2] ? (b[2] = f,
    ...
    (function(a) {
        ...
        C.prototype.hideOverlappingLabels = function(a) {
            var e = a.length, f = this.renderer, n, w, y, c, h, p, k = function(a, c, b, e, f, h, k, n) {
            ...
            for (w = 0; w < e; w++)
                for (p = (y = a[w]) && y.absoluteBox,
                n = w + 1; n < e; ++n)
                    if (h = (c = a[n]) && c.absoluteBox,
                    p && h && y !== c && 0 !== y.newOpacity && 0 !== c.newOpacity && (h = k(p.x, p.y, p.width, p.height, h.x, h.y, h.width, h.height)))
    ...
    (function(a) {
        ...
        J = a.TrackerMixin = {
            ...
            drawTrackerGraph: function() {
                var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, h = f.pointer, k = f.renderer, n = f.options.tooltip.snap, g = a.tracker, q, p = function() {
                    if (f.hoverSeries !== a)
                        a.onMouseOver()
                ...
                if (e && !c)
                    for (q = e + 1; q--; )
                        ...
                        (q && "M" === d[q] || q === e) && d.splice(q, 0, "L", d[q - 2] + n, d[q - 1]);
                g ? g.attr({
                    d: d
        ...
        x(q.prototype, {
            ...
            setState: function(a, b) {
                var c = Math.floor(this.plotX), d = this.plotY, f = this.series, h = f.options.states[a || "normal"] || {}, l = e[f.type].marker && f.options.marker, n = l && !1 === l.enabled, q = l && l.states && l.states[a || "normal"] || {}, g = !1 === q.enabled, p = f.stateMarkerGraphic, v = this.marker || {}, u = f.chart, w = f.halo, y, C = l && f.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === h.enabled || a && (g || n && !1 === q.enabled) || a && v.states && v.states[a] && !1 === v.states[a].enabled)) {
                    ...
                    if (this.graphic)
                        ...
                        this.graphic.animate(f.pointAttribs(this, a), k(u.options.chart.animation, h.animation)),
                        y && this.graphic.animate(y, k(u.options.chart.animation, q.animation, l.animation)),
                        p && p.hide();
                    else {
                        if (a && q) {
                            l = v.symbol || f.symbol;
                            ...
                            if (p)
                                ...
                                l && (f.stateMarkerGraphic = p = u.renderer.symbol(l, y.x, y.y, y.width, y.height).add(f.markerGroup),
                                p.currentSymbol = l);
                    ...
                    (c = h.halo) && c.size ? (w || (f.halo = w = u.renderer.path().add((this.graphic || p).parentGroup)),
    ...
    (function(a) {
        ...
        C.prototype.setResponsive = function(e) {
            ...
            var c = a.merge.apply(0, a.map(n, function(c) {
              ...
              , n = n.toString() || void 0;
            n !== (u && u.ruleIds) && (u && this.update(u.undoOptions, e),
    ...
    /*<!-- Semi Chart end -->*/
        ...
        $(document).ready(function () {
            ...
            if ($('input[name="slider"]').length) {
                calculatorRangeSlider($("#loanAmtSlider"), 50000, 4000000, 50000, 1000, true, false, false, "loanAmtSlider");
                calculatorRangeSlider($("#tensureSlider"), 12, 60, 12, 1, true, true, false, "tensureSlider");
                calculatorRangeSlider($("#intrRateSlider"), 10.49, 22, 10.49, 0.5, true, false, true, "intrRateSlider");
            }
        ...
        function Amortization() {
            ...
            var intPaid = 0, prncRepaid = 0, clBlnc = 0;
            var text = "";
            var mobText = "";
            ...
            switch (sitetype) {
                case "hindi":
                    $('#trDynamic').append('<div class="tableRow tableHead">' +
                                   '<div class="tableCell wid20">महीना</div>' +
                                   '<div class="tableCell wid16">ओपनिंग बैलेंस</div>' +
                                   '<div class="tableCell wid16">महीना के दौरान ब्याज का भुगतान</div>' +
                                   '<div class="tableCell wid16">महीना के दौरान प्रिंसिपल का चुकाया</div>' +
            ...
            switch (sitetype) {
                case "hindi":
                    $('#trDynamicMob').append('<div class="mobRow mobTableHead">' +
                                    '<div class="mobTableCell">महीना</div>' +
                                    '<div class="mobTableCell text-right"><select class="selDrop" id="contentSelect">' + selectHTML + '</select><img src="/images/default-source/revamp_new/loans/desktop/down-select.png"></div>' +
                                    '</div>');
                    break;
                case "tamil":
                    break;
                default:
                    $('#trDynamicMob').append('<div class="mobRow mobTableHead">' +
                                    '<div class="mobTableCell">Month</div>' +
                                    '<div class="mobTableCell text-right"><select class="selDrop" id="contentSelect">' + selectHTML + '</select><img src="/images/default-source/revamp_new/loans/desktop/down-select.png"></div>' +
                                    '</div>');
                    break;
            }
            ...
            for (k = 1 ; k <= parseInt($("#tenure").val()) ; k++) {
                ...
                text += ('<div class="tableRow totalCalc" ><div class="tableCell">' + k + '</div>' +
                             '<div class="tableCell"><img src="/images/default-source/revamp_new/loans/desktop/rupee-icon-black.png" class="rupeeIcon-sm">' + dispNum(InitialopBlnc) + '</div>' +
                             '<div class="tableCell"><img src="/images/default-source/revamp_new/loans/desktop/rupee-icon-black.png" class="rupeeIcon-sm">' + dispNum(sumIntPaid) + '</div>' +
                             '<div class="tableCell"><img src="/images/default-source/revamp_new/loans/desktop/rupee-icon-black.png" class="rupeeIcon-sm">' + dispNum(sumprncRepaid) + '</div>' +
                             '<div class="tableCell"><img src="/images/default-source/revamp_new/loans/desktop/rupee-icon-black.png" class="rupeeIcon-sm">' + dispNum(clBlnc) + ' </div></div>');

                
                switch (sitetype) {
                    case "hindi":
                        mobText += ('<div class="monthlyCal show' + k + '" >' +
                             '<div class="mobRow"><div class="mobTableCell">ओपनिंग बैलेंस</div>' + '<div class="mobTableCell text-right"><img src="/images/default-source/revamp_new/loans/desktop/rupee-icon-black.png" class="rupeeIcon-sm">' + dispNum(InitialopBlnc) + '</div></div>' +
                             '<div class="mobRow"><div class="mobTableCell">महीना के दौरान ब्याज का भुगतान</div>' + '<div class="mobTableCell text-right"><img src="/images/default-source/revamp_new/loans/desktop/rupee-icon-black.png" class="rupeeIcon-sm">' + dispNum(sumIntPaid) + '</div></div>' +
                             '<div class="mobRow"><div class="mobTableCell">महीना के दौरान प्रिंसिपल का चुकाया</div>' + '<div class="mobTableCell text-right"><img src="/images/default-source/revamp_new/loans/desktop/rupee-icon-black.png" class="rupeeIcon-sm">' + dispNum(sumprncRepaid) + '</div></div>' +
                             '<div class="mobRow"><div class="mobTableCell">क्लोजिंग बैलेंस</div>' + '<div class="mobTableCell text-right"><img src="/images/default-source/revamp_new/loans/desktop/rupee-icon-black.png" class="rupeeIcon-sm">' + dispNum(clBlnc) + ' </div></div></div>');
                        break;
                    case "tamil":
                        break;
                    default:
        ...
        $('#loan_amount').on('change', function () {
            ...
            if ($('#loan_amount').val() > 4000000) {
                $('#loan_amount').val('40,00,000');
            }
        ...
        $('#interest_rate').on('change', function () {
            ...
            if ($('#interest_rate').val() > 22) {
                $('#interest_rate').val('22%');
            }
